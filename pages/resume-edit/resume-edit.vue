...
import {
  ...
  navigateToResumeProjectExperienceAdd, navigateToResumeSelfRating, navigateToResumeSkills,
...
<template>
  <view class="resume-edit" v-if="resumeInfo">
    ...
    <view class="block p-30 mt-20 bg-white" v-if="studentInfo">
      <view class="block-header">
        ...
        <cr-icon-light name="plus-circle" @click="navigateToResumeSkills"/>
      </view>
    ...
    <view class="block p-30 mt-20 bg-white" v-if="studentInfo">
      <view class="block-header">
        ...
        <cr-icon-light name="cr-icon-edit"  @click="navigateToResumeSelfRating"/>
      </view>
